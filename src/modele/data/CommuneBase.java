...
public class CommuneBase {
     ...
     */
    public CommuneBase(int idCommune, String nomCommune, Departement leDepartement, ArrayList<CommuneBase> lesVoisins, Gare laGare) throws IllegalArgumentException{ 
        if (idCommune < 0 || nomCommune == null || leDepartement == null || lesVoisins == null || laGare == null){
            throw new IllegalArgumentException("L'identifiant de la commune est négatif ou le nom de la commune, le département, les communes voisines ou la gare de la commune est null");
        } else {
    ...
    /**
     * Méthode qui permet de comparer le nombre de communes voisines de deux communes et renvoit 1 si la commune a plus de voisins, -1 si elle en a moins et 0 si elles en ont autant
     * @param autreCommBase l'autre commune à comparer
     * @return 1 si la commune a plus de voisins, -1 si elle en a moins et 0 si elles en ont autant
