...
public class Gare {
     ...
     * @throws IllegalArgumentException si le code de la gare est négatif ou le nom de la gare est null
     */
    ...
    /**
     * Compare deux gares, si la gare courante est fret et voyageur et que l'autre gare n'est que l'un des deux on renvoit 1, si la gare courante est 
     * fret ou voyageur et que l'autre gare est fret et voyageur on renvoit -1 et si les deux gares sont fret ou voyageur ou seulement un des deux chacunes on renvoit 0.
     * @param autreGare l'autre gare à comparer
     * @return 1 si la gare courante est fret et voyageur et que l'autre gare n'est que l'un des deux, -1 si la gare courante est fret ou voyageur et que l'autre gare est fret et voyageur, 0 sinon
     */
