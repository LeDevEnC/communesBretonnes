...
public class ControllerEditInsert extends Edit implements ReceiveInfo<String> {
    ...
    private void validateButtonPressed() {
        ...
        if (!data.containsValue("")) {
            if (this.table.equals("aeroport")) {
                ...
                super.getModel().getCommuneBaseDAO().create(communeBase);
            }
            
            else if (this.table.equals("annee")) {
                int lAnnee = Integer.parseInt(data.get("lAnnee"));
                ...
                CommunesInfoParAnnee communesInfoParAnnee = new CommunesInfoParAnnee(communeBase, annee, nbMaisons,
                        nbAppartements, prixMoyen, prixM2Moyen, surfaceMoyenne, depensesCulturellesTotales, budgetTotal,
                        population);
                ...
                super.getModel().getGareDAO().create(gare, codeCommune);
            }
        }
    ...
    public void receiveInfo(String info) {
        ...
        System.out.println(super.getFieldHashMap().keySet().toString());
        this.table = info;
